                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between">
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="banner__img text-center text-xxl-end">
                                <img src="{{ (!empty($homeslide->home_slide) ? url($homeslide->home_slide) : asset('frontend/assets/img/banner/banner_img.png')) }}" alt="">
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-6">
                            <div class="banner__content">
                                ...
                                <a href="{{ route('about.menu') }}" class="btn banner__btn wow fadeInUp" data-wow-delay=".6s" style="background-color: #09A4B5;">more about me</a>
                            </div>
                        </div>
                    </div>
                </div>
