            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <!-- <div class="tab-pane fade profile-edit pt-3" id="profile-edit"> -->
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="{{ route('store.partner.image') }}" enctype="multipart/form-data">
                  	@csrf
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">     
                        <div class="pt-2">
                          <input type="file" multiple name="partner_multi_image[]" class="form-control" id="image">
                        </div>
