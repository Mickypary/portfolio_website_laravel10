      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ (!empty($adminData->profile_image) ? asset('upload/admin_images/'.$adminData->profile_image) : asset('upload/no_image.jpg')) }}" alt="Profile" class="rounded-circle" width="40px" height="50px">
