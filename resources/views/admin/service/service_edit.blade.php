                ...
                <!-- <div class="tab-pane fade profile-edit pt-3" id="profile-edit"> -->
                  ...
                  <form method="POST" action="{{ route('update.service') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="short_description" class="form-control tinymce-editor" id="short_description" style="height: 200px">{{ $editData->short_description }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="long_description" class="form-control tinymce-editor" id="long_description" style="height: 200px">{{ $editData->long_description }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="other_text" class="form-control tinymce-editor" id="other_text" style="height: 200px">{{ $editData->other_text }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">     
                        ...
                        <img id="showImage" src="{{ (!empty($editData->icon)) ? asset($editData->icon) : url('upload/no_image.jpg') }}" alt="Slides" width="120px" height="120px">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">     
                        ...
                        <img id="showImage" src="{{ (!empty($editData->main_image)) ? asset($editData->main_image) : url('upload/no_image.jpg') }}" alt="Slides" width="120px" height="120px">
                      </div>
                    </div>
